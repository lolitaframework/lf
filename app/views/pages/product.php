  ...
  <main class="widget_area" id="main-solutions">
    ...
    <!-- header of content -->
            ...
            <div class="widget_area main-solutions__header__bg">
                ...
                <div class="main-solutions__header__bg__second-block">
                    ...
                    <div class="main-solutions__header__bg__second-block__polygon">
                        <p><?php echo $additional_product_sub_title ?></p>
                        <?php echo $additional_product_description ?>
                    </div>
                </div>
            </div>
            <!-- /first of two blocks of header -->
            <?php if (is_array($additional_product_industries)): ?>
              <div class="widget_area main-solutions__header__menu">
                <div class="menu-navigation-container">
                  <ul class="menu">
                    <?php foreach ($additional_product_industries as $index => $el): ?>
                      <?php if ($index >= 8): ?>
        ...
        <article class=" widget_area main-solutions__article1">
            <?php the_content(); ?>
            <?php if ('' !== $additional_product_pdf): ?>
              <div class="main-solutions__article1__btn1">
                  <a href="<?php echo $additional_product_pdf ?>"><i class="fa fa-play" aria-hidden="true"></i>&nbsp;Download demo</a>
              </div>
            <?php endif ?>
        </article>
        <!-- /article block 1 -->
        <?php if ('' !== $product_row_1_content): ?>
          <!-- section block -->
          <section class="widget_area main-solutions__value-users">
              <?php echo $product_row_1_content ?>
          </section>
          <!-- /section block -->
        <?php endif ?>
        <!-- article block 2 -->
        <article class=" widget_area main-solutions__article2">
            ...
            <img src="<?php echo $product_row_2_image; ?>" alt="monitor">
        </article>
        <!-- /article block 2 -->
        <!-- section block -->
        <section class=" widget_area main-solutions__screenshots">
            ...
            <div class="widget main-solutions__screenshots__slider">
                <?php foreach ((array) $product_row_3_screenshots as $key => $value): ?>
                  <div class="main-solutions__screenshots__slider__item">
                    ...
                    <div class="main-solutions__screenshots__slider__item__txt">
                        <?php echo $product_row_3_content ?>
                    </div>
                  </div>
                <?php endforeach ?>
            </div>
            <?php foreach ((array) $product_row_4_Info as $el): ?>
            ...
            <div class="main-solutions__doze__btn-line">
                <?php if ('' !== $additional_product_pdf): ?>
                  <div class="main-solutions__doze__btn-line__btn">
                    <a href="<?php echo $additional_product_pdf ?>">
